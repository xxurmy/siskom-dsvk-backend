<?php
// database/seeders/KolokiumSeeder.php
...
class KolokiumSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // Ambil ~70% mahasiswa untuk didaftarkan kolokium (mensimulasikan
        // kondisi nyata: tidak semua mahasiswa sudah daftar kolokium)
        $jumlahTerpilih = (int) ($mahasiswaList->count() * 0.7);
        ...
        foreach ($mahasiswaTerpilih as $mhs) {
            ...
            // Moderator, tanggal, waktu, ruangan hanya terisi kalau kolokium
            ...
            if ($status === 'approved') {
                ...
                // Mahasiswa boleh isi tanggal/waktu/lokasi usulan saat mendaftar,
        ...
        $this->command->info("Berhasil membuat {$mahasiswaTerpilih->count()} data kolokium.");
    }
